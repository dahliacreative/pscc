...
<form enctype="multipart/form-data" class="form-stacked miniSurveyView" id="miniSurveyView<?php  echo $bID; ?>" method="post" action="<?php  echo $formAction ?>" data-behaviour="ajax-form">
    
    <h3 class="section__title"><?php echo $surveyName ?></h3>
  ...
  <div class="fields">
    ...
    <?php  foreach ($questions as $question): ?>
      <div class="form-group field field-<?php  echo $question['type']; ?> <?php echo isset($errorDetails[$question['msqID']]) ? 'has-error' : ''?>">
        <label class="control-label<?php if ($question['required']) echo ' required' ?>" <?php  echo $question['labelFor']; ?>>
